    ...
    return ( 
        <section className="bg-[#F8F9FA] pb-10 px-10">
            ...
            <div className="flex">
                ...
                <div>
                    <div onClick={() => setShowModal(true)} className=" flex mr-5 justify-center align-middle relative h-52 w-40 border-2 cursor-pointer items-center hover:border-[#00b8d1]">
                        <Icon
                            style={{color: '#00b8d1'}}
                            name="color_lens" 
                            size="6xl" />
